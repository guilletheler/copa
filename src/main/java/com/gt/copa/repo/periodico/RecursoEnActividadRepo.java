...
public interface RecursoEnActividadRepo extends PagingAndSortingRepository<RecursoEnActividad, Integer>,
    ...
    List<RecursoEnActividad> findByRecurso_EmpresaAndConfiguracionPeriodo_EscenarioAndConfiguracionPeriodo_Periodo(Empresa empresa, Escenario escenario, Periodo periodo);
