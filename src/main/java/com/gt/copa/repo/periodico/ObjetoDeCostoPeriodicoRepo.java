...
public interface ObjetoDeCostoPeriodicoRepo extends PagingAndSortingRepository<ObjetoDeCostoPeriodico, Integer>,
    ...
    List<ObjetoDeCostoPeriodico> findByObjetoDeCosto_EmpresaAndConfiguracionPeriodo_EscenarioAndConfiguracionPeriodo_Periodo(Empresa empresa, Escenario escenario, Periodo periodo);
