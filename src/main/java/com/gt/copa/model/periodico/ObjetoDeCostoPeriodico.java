...
public class ObjetoDeCostoPeriodico implements Serializable {
    ...
    @Id
    @TableGenerator(table = "hibernate_sequences", name = "ocenperiodico_gen", pkColumnName = "sequence_name",
            valueColumnName = "sequence_next_hi_value", allocationSize = 1, pkColumnValue = "objetosdecostoperiodicos")
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "ocenperiodico_gen")
    private Integer id;
